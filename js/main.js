...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const resourcesData = [
    ...
    { title: "Arcade Points Calculator", desc: "Community tool to estimate Arcade game points, skill badge points, milestones, and next-target progress.", link: "points-calculator.html", type: "Community", badge: "badge-community", icon: "calculator", buttonText: "Open Community Tool" },
